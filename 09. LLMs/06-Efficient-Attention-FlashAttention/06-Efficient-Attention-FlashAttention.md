...
Standard scaled-dot-product [attention](../../deep-learning/attention-and-transformers/attention-mechanism/attention-mechanism.md) over a sequence of $N$ tokens does three steps:
