...
- Foundations (the *why* behind Q, K, V and softmax): [Attention Mechanism](../../deep-learning/attention-and-transformers/attention-mechanism/attention-mechanism.md) · [Transformer Architecture](../../deep-learning/attention-and-transformers/transformer-architecture/transformer-architecture.md)
