...
- **RAG** ([retrieval-augmented generation](../../15.%20RAG_and_LLM_Applications/README.md)) is ICL with *retrieved* context: the retrieved documents are in-context information the model conditions on at inference time, no weights touched.
