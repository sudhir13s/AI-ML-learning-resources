...
- **RAG** ([retrieval-augmented generation](../../llms-applications-and-agents/rag-and-knowledge-systems/overview.md)) is ICL with *retrieved* context: the retrieved documents are in-context information the model conditions on at inference time, no weights touched.
