...
- Why capacity matters: [Scaling Laws](03-Scaling-Laws.md) · [Pretraining at Scale](02-Pretraining-at-Scale.md)
- Builds on this: [Decoder-only Architecture](04-Decoder-only-Architecture.md) · [KV Cache](05-KV-Cache.md) · [Quantization](10-Quantization.md)
