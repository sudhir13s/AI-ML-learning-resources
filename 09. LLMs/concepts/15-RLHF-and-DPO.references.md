...
- Prerequisites: [Supervised Fine-Tuning](13-Supervised-Fine-Tuning.md) · [Instruction Tuning](14-Instruction-Tuning.md)
- RL foundations: [Reinforcement Learning](../../08.%20Reinforcement_Learning/concepts/README.md) (PPO & policy gradients)
- Related: [Hallucination & Alignment Basics](20-Hallucination-and-Alignment-Basics.md)
