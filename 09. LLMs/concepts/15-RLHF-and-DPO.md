...
3. **Get the RL mechanics** — review [PPO & policy gradients](../../08.%20Reinforcement_Learning/concepts/README.md) (the RL engine under RLHF). *PPO is the optimizer doing the work.*
...
- Foundations (covered elsewhere): [PPO & policy-gradient mechanics → Reinforcement Learning](../../08.%20Reinforcement_Learning/concepts/README.md)
