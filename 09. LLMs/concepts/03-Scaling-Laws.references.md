...
- The phase these laws govern: [Pretraining at Scale](02-Pretraining-at-Scale.md) · [Language Modeling Objectives](01-Language-Modeling-Objectives.md)
- The architecture being scaled: [Decoder-only Architecture](04-Decoder-only-Architecture.md)
- Why inference cost reshapes the optimum: [KV Cache](05-KV-Cache.md) · [Inference Optimization & Serving](09-Inference-Optimization-and-Serving.md) · [Quantization](10-Quantization.md)
- A different way to scale parameters cheaply: [Mixture-of-Experts](07-Mixture-of-Experts.md)
