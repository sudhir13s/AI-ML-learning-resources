...
- The objective it's trained on: [Language Modeling Objectives](01-Language-Modeling-Objectives.md) · [Pretraining at Scale](02-Pretraining-at-Scale.md) · [Scaling Laws](03-Scaling-Laws.md)
- The inference it enables: [KV Cache](05-KV-Cache.md) · [Long-Context Methods](08-Long-Context-Methods.md) · [Mixture of Experts](07-Mixture-of-Experts.md) · [Inference Optimization & Serving](09-Inference-Optimization-and-Serving.md)
- What it unlocks: [Prompting & In-Context Learning](16-Prompting-and-In-Context-Learning.md) · [Decoding & Sampling](18-Decoding-and-Sampling.md) · [Supervised Fine-Tuning](13-Supervised-Fine-Tuning.md) · [RLHF & DPO](15-RLHF-and-DPO.md)
