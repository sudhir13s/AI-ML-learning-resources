...
5. **See the mechanism of fixes** — [RLHF & DPO](15-RLHF-and-DPO.md) + ground with [RAG](../../11.%20RAG_and_LLM_Applications/concepts/README.md). *Preference tuning + retrieval are the main levers.*
