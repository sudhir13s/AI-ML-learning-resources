...
5. **Connect the fixes** — [RLHF & DPO](../15-RLHF-and-DPO/15-RLHF-and-DPO.md) (preference tuning) + [RAG](../../llms-applications-and-agents/rag-and-knowledge-systems/overview.md) (grounding) + [Decoding & Sampling](../18-Decoding-and-Sampling/18-Decoding-and-Sampling.md) (temperature). *The main levers, each its own chapter.*
...
- The mechanism of the fixes: [RLHF & DPO](../15-RLHF-and-DPO/15-RLHF-and-DPO.md) · [RAG & LLM Applications](../../llms-applications-and-agents/rag-and-knowledge-systems/overview.md) · [Decoding & Sampling](../18-Decoding-and-Sampling/18-Decoding-and-Sampling.md) · [Chain-of-Thought Reasoning](../17-Chain-of-Thought-Reasoning/17-Chain-of-Thought-Reasoning.md)
