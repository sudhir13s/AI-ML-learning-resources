...
![The toy knowledge distribution reshaped by temperature T = 0.5, 1.0, 2.0. The supported answer (green) holds 0.93 of the mass at T=0.5 but only 0.37 at T=2.0 — the rest bleeds onto wrong distractors (red). This is the cause of the rising hallucination rate.](../images/hall_temperature_dists.png)
