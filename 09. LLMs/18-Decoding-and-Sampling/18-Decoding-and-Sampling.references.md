...
- Foundations: [Loss Functions (softmax & cross-entropy)](../../deep-learning/optimization-and-training/loss-functions/loss-functions.md) · [Language Modeling Objectives](../01-Language-Modeling-Objectives/01-Language-Modeling-Objectives.md) · [Decoder-only Architecture](../04-Decoder-only-Architecture/04-Decoder-only-Architecture.md)
