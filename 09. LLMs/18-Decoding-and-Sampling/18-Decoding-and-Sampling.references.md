...
- Foundations: [Loss Functions (softmax & cross-entropy)](../../05.%20Deep_Learning/04-Loss-Functions/04-Loss-Functions.md) · [Language Modeling Objectives](../01-Language-Modeling-Objectives/01-Language-Modeling-Objectives.md) · [Decoder-only Architecture](../04-Decoder-only-Architecture/04-Decoder-only-Architecture.md)
