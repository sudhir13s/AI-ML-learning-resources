...
![The same teacher logits softened at T=1, T=4, and T=10. At T=1 the 'cat' bar dwarfs everything and the dog/lynx mass is invisible (0.05, 0.02). At T=4 the dog (0.22) and lynx (0.17) mass emerges clearly — that emerging off-target mass IS the dark knowledge. At T=10 the distribution is nearly flat, over-softened.](../images/kd_temperature_softening.png)
