...
5. **Connect to cost** — [FlashAttention](../06-Efficient-Attention-FlashAttention/06-Efficient-Attention-FlashAttention.md) + [KV Cache](../05-KV-Cache/05-KV-Cache.md). *The compute/memory levers that make long context affordable.*
...
- Related concepts: [Efficient Attention (FlashAttention)](../06-Efficient-Attention-FlashAttention/06-Efficient-Attention-FlashAttention.md) · [KV Cache](../05-KV-Cache/05-KV-Cache.md) · [Decoder-only Architecture](../04-Decoder-only-Architecture/04-Decoder-only-Architecture.md)
