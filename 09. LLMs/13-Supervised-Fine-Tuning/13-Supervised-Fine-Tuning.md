...
5. **Make it efficient** — [LoRA / PEFT](../12-LoRA-and-PEFT/12-LoRA-and-PEFT.md). *How SFT is actually run on consumer hardware.*
...
- Related concepts: [LoRA / PEFT](../12-LoRA-and-PEFT/12-LoRA-and-PEFT.md) · [Instruction Tuning](../14-Instruction-Tuning/14-Instruction-Tuning.md) · [RLHF & DPO](../15-RLHF-and-DPO/15-RLHF-and-DPO.md)
