---
id: "12-agentic-ai/react/references"
topic: "ReAct — References"
parent: "12-agentic-ai/react"
type: references
updated: 2026-07-02
---
...
> Companion link library for **[ReAct — Reason + Act](02-ReAct-Reason-and-Act.md)** (the concept
...
**🔗 In this platform**:
- Concept page (full explanation): [ReAct — Reason + Act](02-ReAct-Reason-and-Act.md)
...
- Prev / next in this domain: [01 LLM Agents Overview](../01-LLM-Agents-Overview/01-LLM-Agents-Overview.md) · [03 Tool Use & Function Calling](../03-Tool-Use-and-Function-Calling/03-Tool-Use-and-Function-Calling.md) · [04 Planning & Task Decomposition](../04-Planning-Task-Decomposition/04-Planning-Task-Decomposition.md)
- Where it goes next: [05 Reflection & Self-Critique](../05-Reflection-and-Self-Critique/05-Reflection-and-Self-Critique.md) (the Reflexion outer loop) · [06 Memory for Agents](../06-Memory-for-Agents/06-Memory-for-Agents.md) (when the scratchpad outgrows the context)
- Tool + safety context: [08 Model Context Protocol (MCP)](../08-Model-Context-Protocol-MCP/08-Model-Context-Protocol-MCP.md) · [13 Safety, Guardrails & Human-in-the-Loop](../13-Safety-Guardrails-and-Human-in-the-Loop/13-Safety-Guardrails-and-Human-in-the-Loop.md)
