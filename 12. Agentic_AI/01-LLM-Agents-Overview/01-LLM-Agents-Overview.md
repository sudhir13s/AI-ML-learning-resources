...
- Next concepts: [02 ReAct](../02-ReAct-Reason-and-Act/02-ReAct-Reason-and-Act.md) · [03 Tool Use & Function Calling](../03-Tool-Use-and-Function-Calling/03-Tool-Use-and-Function-Calling.md) · [04 Planning](../04-Planning-Task-Decomposition/04-Planning-Task-Decomposition.md)
- Related (canonical home): [Prompting & In-Context Learning](../../09.%20LLMs/16-Prompting-and-In-Context-Learning/16-Prompting-and-In-Context-Learning.md) · [Chain-of-Thought](../../09.%20LLMs/17-Chain-of-Thought-Reasoning/17-Chain-of-Thought-Reasoning.md)
