---
id: "12-agentic-ai/tool-use-function-calling/references"
topic: "Tool Use & Function Calling — References"
parent: "12-agentic-ai/tool-use-function-calling"
type: references
updated: 2026-07-02
---
...
> Companion link library for **[Tool Use & Function Calling](03-Tool-Use-and-Function-Calling.md)** (the
...
**🔗 In this platform**:
- Concept page (full explanation): [Tool Use & Function Calling](03-Tool-Use-and-Function-Calling.md)
...
- The text-protocol contrast (read these together): [02 ReAct — Reason + Act](../02-ReAct-Reason-and-Act/02-ReAct-Reason-and-Act.md) — free-text actions parsed by regex; *this* page is the structured evolution.
- Where tools get standardised across the ecosystem: [08 Model Context Protocol (MCP)](../08-Model-Context-Protocol-MCP/08-Model-Context-Protocol-MCP.md) — the forward-link; function calling is how *one model* calls a tool, MCP is how the *ecosystem* shares tools.
- Prev / next in this domain: [02 ReAct](../02-ReAct-Reason-and-Act/02-ReAct-Reason-and-Act.md) · [04 Planning & Task Decomposition](../04-Planning-Task-Decomposition/04-Planning-Task-Decomposition.md)
- Safety context (the tool-input + tool-output trust boundary): [13 Safety, Guardrails & Human-in-the-Loop](../13-Safety-Guardrails-and-Human-in-the-Loop/13-Safety-Guardrails-and-Human-in-the-Loop.md)
- Frameworks that implement this loop: [09 Agent Frameworks](../09-Agent-Frameworks/09-Agent-Frameworks.md)
