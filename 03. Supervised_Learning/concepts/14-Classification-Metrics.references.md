...
5. **Make it concrete** — compute `classification_report` and `roc_auc_score` on an imbalanced dataset; watch accuracy stay high while recall collapses.
...
**Key papers**:
- [The Relationship Between Precision-Recall and ROC Curves](https://www.biostat.wisc.edu/~page/rocpr.pdf) — **Davis & Goadrich (2006)** — *why* PR curves are more informative than ROC under class imbalance.
