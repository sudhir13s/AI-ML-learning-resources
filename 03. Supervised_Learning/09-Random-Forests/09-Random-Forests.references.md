...
- Related: [Bagging](../08-Bagging/08-Bagging.md) (forests are bagging + feature randomness) · [Decision Trees](../07-Decision-Trees/07-Decision-Trees.md) (the base learner) · [Bias–Variance Tradeoff](../12-Bias-Variance-Tradeoff/12-Bias-Variance-Tradeoff.md) · [Gradient Boosting (XGBoost)](../10-Gradient-Boosting-XGBoost/10-Gradient-Boosting-XGBoost.md) (boosting cuts bias; forests cut variance)
- Math prerequisites: [01. Foundations](../../01.%20Foundations/README.md) — variance of an average, correlation, the bootstrap
