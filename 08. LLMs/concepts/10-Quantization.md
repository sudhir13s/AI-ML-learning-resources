...
5. **Connect to fine-tuning** — [LoRA / PEFT](12-LoRA-and-PEFT.md). *QLoRA fine-tunes on top of a 4-bit base — quantization + adapters.*
...
- Related concepts: [Knowledge Distillation](11-Knowledge-Distillation.md) · [LoRA / PEFT](12-LoRA-and-PEFT.md) · [Inference Optimization & Serving](09-Inference-Optimization-and-Serving.md)
