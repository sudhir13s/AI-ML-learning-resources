...
3. **Get the math** — read [Foundations — PCA/SVD (this platform)](../../1.%20Foundations/Maths%20for%20AI-ML/README.md) + [scikit-learn PCA user guide](https://scikit-learn.org/stable/modules/decomposition.html#pca). *Eigendecomposition of the covariance = the SVD; explained-variance ratio.*
...
## 🔗 In this platform
- The PCA/SVD math (eigendecomposition, variance maximization, the SVD view): [Foundations — Maths for AI-ML](../../1.%20Foundations/Maths%20for%20AI-ML/README.md) · concept depth [AI-ML-intuition 1.05 Spectral Methods (PCA / SVD)](../../../AI-ML-intuition/Module_1_Representation/1.05_Spectral_Methods_PCA_SVD.md)
- Non-linear methods: [07 t-SNE](07-t-SNE.md) · [08 UMAP](08-UMAP.md)
- Learned (non-linear) compression: [Autoencoders → Deep Learning](../../5.%20Deep_Learning/README.md)
