---
id: "11-tools-and-frameworks/hugging-face"
...
## 🔗 In this platform
- Related domain: [08. LLMs](../../08.%20LLMs/concepts/README.md) · [06. NLP](../../06.%20NLP/concepts/README.md) · [09. GenAI](../../09.%20GenAI/concepts/README.md)
- Pairs with: [05 PyTorch](05-PyTorch.md) · [13 Gradio & Streamlit](13-Gradio-and-Streamlit.md)
- Deeper concept (the *why*): transformers & LLM internals → [Deep Learning](../../05.%20Deep_Learning/concepts/README.md); RAG pipelines → [RAG & LLM Applications](../../16.%20RAG_and_LLM_Applications/concepts/README.md)
