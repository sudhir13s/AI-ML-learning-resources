...
> [Diffusion](../11.%20Diffusion/README.md); classic optical flow lives in
> [Computer Vision](../07.%20Computer%20Vision/README.md).
...
- **Optical flow & classic video features** → [Computer Vision · Optical Flow & Video](../07.%20Computer%20Vision/README.md)
- **Object tracking & detection backbones** → [Computer Vision](../07.%20Computer%20Vision/README.md)
- **Video diffusion / generation** → [Diffusion · Video Diffusion Models](../11.%20Diffusion/README.md)
- **VLM fusion architectures** → [Multimodal](../12.%20Multimodal/README.md)
...
## 🔗 In this platform
- Backbones: [Computer Vision](../07.%20Computer%20Vision/README.md) · Reasoning side: [Multimodal](../12.%20Multimodal/README.md)
