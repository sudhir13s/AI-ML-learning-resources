...
- Prev / next: [05 Reflection & Self-Critique](../05-Reflection-and-Self-Critique/05-Reflection-and-Self-Critique.md) · [07 Multi-Agent Systems](../07-Multi-Agent-Systems-and-Orchestration/07-Multi-Agent-Systems-and-Orchestration.md)
- Related (canonical home): long-term memory is retrieval — see [RAG & LLM Applications](../../15.%20RAG_and_LLM_Applications/README.md)
