...
- Related (text analogue): [LLMs](../../08.%20LLMs/README.md) · [NLP — Decoding Strategies](../../06.%20NLP/concepts/17-Decoding-Strategies.md) (sampling from autoregressive conditionals)
