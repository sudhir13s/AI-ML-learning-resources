...
- Related concept (covered elsewhere): LLM inference internals (KV-cache, paged attention) → [08. LLMs — Inference Optimization & Serving](../../08.%20LLMs/concepts/09-Inference-Optimization-and-Serving.md)
