...
latency. Builds on LLM internals (covered in 08. LLMs) but focuses on *operating* LLM systems.
...
- Related concepts (covered elsewhere): LLM evaluation & benchmarks → [08. LLMs — LLM Evaluation](../../08.%20LLMs/concepts/19-LLM-Evaluation-and-Benchmarks.md) · prompting & in-context learning → [08. LLMs — Prompting](../../08.%20LLMs/concepts/16-Prompting-and-In-Context-Learning.md) · LLM inference cost/latency internals → [08. LLMs — Inference Optimization & Serving](../../08.%20LLMs/concepts/09-Inference-Optimization-and-Serving.md)
