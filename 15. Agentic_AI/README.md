...
Looking for the best **free** course, video, paper, article, or book on a *specific* agentic topic
(ReAct, tool use, planning, memory, MCP, multi-agent, evaluation, safety)?
See the **[Concept Index →](concepts/README.md)** — one guided resource card per concept.
