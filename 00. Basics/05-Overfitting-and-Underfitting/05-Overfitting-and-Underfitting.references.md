...
**In this platform**:
- Concept page (full explanation): [Overfitting & Underfitting](05-Overfitting-and-Underfitting.md)
- Previous concept — how the training loss falls in the first place: [04 How Models Learn](../04-How-Models-Learn/04-How-Models-Learn.md)
- The classification loss used across the repo, derived: [23 Cross-Entropy and KL Divergence](../../01.%20Foundations/23-Cross-Entropy-and-KL-Divergence/23-Cross-Entropy-and-KL-Divergence.md)
- The theory of the training loop (convergence, SGD, why the loss falls): [13 Gradient Descent Theory](../../01.%20Foundations/13-Gradient-Descent-Theory/13-Gradient-Descent-Theory.md)
- Put it all together on a real dataset with a train/validation split: [12 Your First ML Project](../12-Your-First-ML-Project/12-Your-First-ML-Project.md)
- Go deeper — ridge, lasso, and regularization in linear models: [03. Supervised Learning](../../03.%20Supervised_Learning/README.md)
- Go deeper — dropout, weight decay, early stopping, augmentation: [05. Deep Learning](../../05.%20Deep_Learning/README.md)
