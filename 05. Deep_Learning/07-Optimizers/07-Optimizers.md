...
**→ [Learning-Rate Schedules & Warmup](../08-Learning-Rate-Schedules-and-Warmup/08-Learning-Rate-Schedules-and-Warmup.md)** covers cosine/linear/inverse-sqrt decay, warmup length, and restarts in depth.
