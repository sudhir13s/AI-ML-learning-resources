...
- Related: [Activation Functions](../03-Activation-Functions/03-Activation-Functions.md) (saturation) · [Weight Initialization](../05-Weight-Initialization/05-Weight-Initialization.md) · [Normalization](../11-Normalization/11-Normalization.md) · [Residual / Skip Connections](../18-Residual-Skip-Connections/18-Residual-Skip-Connections.md) · [RNN / LSTM / GRU](../14-RNN-LSTM-GRU/14-RNN-LSTM-GRU.md) (through-time fix) · [Transformer Architecture](../16-Transformer-Architecture/16-Transformer-Architecture.md)
