...
- Prerequisite: [Activation Functions](03-Activation-Functions.md) (softmax — the partner that pairs with cross-entropy)
- The gradient in context: [Backpropagation & Computational Graphs](02-Backpropagation-and-Computational-Graphs.md) (the $\hat y - y$ vector seeds the backward pass) · [Optimizers](07-Optimizers.md) (what minimizes the loss surface)
- Related theory: [Cross-Entropy & KL Divergence](../../01.%20Foundations/concepts/23-Cross-Entropy-and-KL-Divergence.md) (the information-theory foundation) · [Regularization](09-Regularization.md) (penalized loss = MAP under a prior; label smoothing)
