...
Residuals and [normalization](11-Normalization.md) are best understood as a pair, because *where you put the norm relative to the residual add* decides whether your deep transformer trains stably.
