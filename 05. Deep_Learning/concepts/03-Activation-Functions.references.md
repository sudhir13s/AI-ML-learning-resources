...
- Related: [Vanishing / Exploding Gradients](06-Vanishing-Exploding-Gradients.md) (why saturating activations hurt) · [Backpropagation & Computational Graphs](02-Backpropagation-and-Computational-Graphs.md) (where the chained derivatives multiply) · [Loss Functions](04-Loss-Functions.md) (softmax + cross-entropy) · [Transformer Architecture](16-Transformer-Architecture.md) (where GELU/SwiGLU and softmax sit)
