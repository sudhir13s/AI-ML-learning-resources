...
- Prerequisite: [Regularization](09-Regularization.md) (L1/L2, early stopping — the family dropout belongs to)
- Related: [Normalization](11-Normalization.md) (BatchNorm — the variance-shift conflict; LayerNorm pairs with dropout) · [Residual / Skip Connections](18-Residual-Skip-Connections.md) (stochastic depth / DropPath, dropout at the block level) · [Transformer Architecture](16-Transformer-Architecture.md) (where attention / residual / FFN dropout live)
