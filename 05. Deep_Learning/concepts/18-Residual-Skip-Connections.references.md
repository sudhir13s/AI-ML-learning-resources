...
- Related: [Transformer Architecture](16-Transformer-Architecture.md) (residuals around attention + FFN) · [Attention Mechanism](15-Attention-Mechanism.md) (the residual stream) · [Normalization](11-Normalization.md) (pre-norm pairs with residuals)
