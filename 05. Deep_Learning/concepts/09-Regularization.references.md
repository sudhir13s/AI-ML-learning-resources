...
- Related (deep-learning): [Dropout](10-Dropout.md) (the stochastic regularizer in full) · [Optimizers](07-Optimizers.md) (AdamW and decoupled weight decay) · [Normalization](11-Normalization.md) (BatchNorm's regularizing side-effect) · [Residual / Skip Connections](18-Residual-Skip-Connections.md) (the identity path stochastic depth rides on)
