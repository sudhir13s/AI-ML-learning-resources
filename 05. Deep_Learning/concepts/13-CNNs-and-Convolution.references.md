...
- Related: [Normalization](11-Normalization.md) (BatchNorm lives in CNNs) · [Residual / Skip Connections](18-Residual-Skip-Connections.md) (what made CNNs go deep) · [Vanishing & Exploding Gradients](06-Vanishing-Exploding-Gradients.md) (the problem residuals solve) · [Attention Mechanism](15-Attention-Mechanism.md) (the CNN-vs-Transformer trade) · [Computer Vision](../../07.%20Computer%20Vision/concepts/README.md) (vision architectures, detection, segmentation in depth)
