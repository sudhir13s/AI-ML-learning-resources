...
- Related (linear models): [Regularization for Linear Models — Ridge · Lasso · Elastic-Net](../../03.%20Supervised_Learning/03-Regularization-Linear-Models/03-Regularization-Linear-Models.md) (the diamond-vs-circle geometry + closed forms) · [Bias–Variance Tradeoff](../../03.%20Supervised_Learning/12-Bias-Variance-Tradeoff/12-Bias-Variance-Tradeoff.md) (double descent)
