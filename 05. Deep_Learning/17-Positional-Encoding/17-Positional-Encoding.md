...
- **Decoder-only LLMs** (the dominant design — see [Transformer Architecture](../16-Transformer-Architecture/16-Transformer-Architecture.md)) almost universally use **RoPE** today, often with YaRN/NTK scaling for long context.
