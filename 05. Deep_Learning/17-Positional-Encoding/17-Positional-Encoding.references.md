...
- Prerequisites (the *why* behind Q, K, V and the block): [Attention Mechanism](../15-Attention-Mechanism/15-Attention-Mechanism.md) · [Transformer Architecture](../16-Transformer-Architecture/16-Transformer-Architecture.md)
- Builds on this (RoPE caching, long context): [KV Cache](../../09.%20LLMs/05-KV-Cache/05-KV-Cache.md)
...
- Related domain: [09. LLMs](../../09.%20LLMs/README.md) (RoPE/ALiBi for long-context models)
