...
- Related theory: [Cross-Entropy & KL Divergence](../../01.%20Foundations/23-Cross-Entropy-and-KL-Divergence/23-Cross-Entropy-and-KL-Divergence.md) (the information-theory foundation) · [Regularization](../09-Regularization/09-Regularization.md) (penalized loss = MAP under a prior; label smoothing)
- Loss vs metric (evaluation side): [Classification Metrics](../../03.%20Supervised_Learning/14-Classification-Metrics/14-Classification-Metrics.md) · [Regression Metrics](../../03.%20Supervised_Learning/15-Regression-Metrics/15-Regression-Metrics.md)
