...
- connect the step-function perceptron to its smooth cousin [logistic regression](../../03.%20Supervised_Learning/concepts/02-Logistic-Regression.md) and to gradient-descent training via [backprop](../02-Backpropagation-and-Computational-Graphs/02-Backpropagation-and-Computational-Graphs.md).
