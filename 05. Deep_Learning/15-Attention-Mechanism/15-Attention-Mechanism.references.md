...
- Prerequisite: [14 RNN / LSTM / GRU](../14-RNN-LSTM-GRU/14-RNN-LSTM-GRU.md) (the bottleneck attention fixed)
- Needed because attention is order-blind: [17 Positional Encoding](../17-Positional-Encoding/17-Positional-Encoding.md) (sinusoidal, learned, RoPE, ALiBi)
- Builds into: [16 Transformer Architecture](../16-Transformer-Architecture/16-Transformer-Architecture.md) — attention wrapped in residual + norm + FFN into a full model
