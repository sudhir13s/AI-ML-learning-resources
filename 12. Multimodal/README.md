...
> [Diffusion](../11.%20Diffusion/README.md)/[GenAI](../10.%20GenAI/README.md); this topic is
...
- **Vision Transformers (ViT)** — the visual backbone → [Computer Vision · Vision Transformers](../07.%20Computer%20Vision/README.md)
- **Text-to-image generation** → [Diffusion](../11.%20Diffusion/README.md) · [GenAI](../10.%20GenAI/README.md)
- **Speech understanding & audio tokens** → [Audio & Speech](../14.%20Audio_and_Speech/README.md)
- **Video-language models** → [Video Understanding](../13.%20Video_Understanding/README.md)
...
## 🔗 In this platform
- Backbones: [Computer Vision](../07.%20Computer%20Vision/README.md) · Language side: [LLMs](../09.%20LLMs/README.md)
