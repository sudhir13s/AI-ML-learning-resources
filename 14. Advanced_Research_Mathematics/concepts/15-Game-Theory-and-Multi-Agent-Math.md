---
id: "14-advanced-math/game-theory-multi-agent"
...
5. **Connect to ML** — read [GANs](https://arxiv.org/abs/1406.2661) and link to [bandits/RL](../../10.%20Reinforcement_Learning/concepts/README.md). *Minimax games, self-play, and learning dynamics in modern ML.*
...
- Related domain (multi-agent decisions): [10. Reinforcement Learning](../../10.%20Reinforcement_Learning/concepts/README.md)
</content>
