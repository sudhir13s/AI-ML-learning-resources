...
## 🔗 In this platform
- Builds on: [01 ML Lifecycle & MLOps Maturity](../../lifecycle-and-reproducibility/ml-lifecycle-and-mlops-maturity/ml-lifecycle-and-mlops-maturity.md) · [06 ML Pipelines & Orchestration](../../data-and-training-platforms/ml-pipelines-and-orchestration/ml-pipelines-and-orchestration.md)
- Next concepts: [12 Data & Concept Drift Detection](../../monitoring-and-reliability/data-and-concept-drift-detection/data-and-concept-drift-detection.md) · [14 A/B Testing · Shadow & Canary](../ab-testing-shadow-and-canary-deployment/ab-testing-shadow-and-canary-deployment.md)
