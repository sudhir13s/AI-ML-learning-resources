...
5. **Connect to cost** — move to [16 Cost Optimization](../../governance-and-economics/cost-optimization/cost-optimization.md). *Autoscaling, batching, and GPU sharing are the main levers on the inference bill.*
