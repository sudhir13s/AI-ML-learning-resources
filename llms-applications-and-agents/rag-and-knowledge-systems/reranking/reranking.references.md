...
**In this platform**:
- Concept page (full explanation): [Re-ranking with Cross-Encoders](reranking.md)
- Prereqs (the first stage this re-ranks): [03 Embedding Models for Retrieval](../embedding-models/embedding-models.md) · [04 Vector Databases & ANN Indexes](../vector-search/vector-search.md) · [05 Hybrid Search (BM25 + Dense)](../hybrid-search/hybrid-search.md)
- Foundations (the *why* behind attention & similarity): [AI-ML-intuition 1.06 Vector Similarities — Scaled Dot-Product](../../../../AI-ML-intuition/Module_1_Representation/1.06_Vector_Similarities_The_Scaled_Dot-Product.md) · [05. Deep Learning — Attention Mechanism](../../../deep-learning/attention-and-transformers/attention-mechanism/attention-mechanism.md) · [06. NLP — Information Retrieval & Semantic Search](../../../modalities-and-generative-models/natural-language-processing/information-retrieval-and-semantic-search/information-retrieval-and-semantic-search.md)
- Next in this domain (raise the recall ceiling re-ranking is bounded by): [07 Query Transformation (HyDE, Multi-Query)](../query-transformation/query-transformation.md)
