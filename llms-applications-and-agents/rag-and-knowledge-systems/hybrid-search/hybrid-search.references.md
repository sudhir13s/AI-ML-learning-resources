...
- Foundations (the *why* behind the math): [AI-ML-intuition 1.06 Vector Similarities — Scaled Dot-Product](../../../../AI-ML-intuition/representation/similarity-and-distance/scaled-dot-product-intuition.md) · [1.17 BoW & TF-IDF](../../../../AI-ML-intuition/representation/discrete-representations/bag-of-words-and-tf-idf-intuition.md) · [06. NLP — Bag-of-Words & TF-IDF](../../../modalities-and-generative-models/natural-language-processing/bag-of-words-and-tf-idf/bag-of-words-and-tf-idf.md) · [06. NLP — Information Retrieval & Semantic Search](../../../modalities-and-generative-models/natural-language-processing/information-retrieval-and-semantic-search/information-retrieval-and-semantic-search.md)
