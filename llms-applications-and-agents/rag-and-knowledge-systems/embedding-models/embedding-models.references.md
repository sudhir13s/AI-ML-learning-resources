...
- Foundations (the *why* behind vectors & similarity): [AI-ML-intuition 1.02 Dense Embeddings](../../../../AI-ML-intuition/representation/embedding-spaces/dense-embeddings-intuition.md) · [1.06 Vector Similarities — Scaled Dot-Product](../../../../AI-ML-intuition/representation/similarity-and-distance/scaled-dot-product-intuition.md) · [06. NLP — Sentence & Document Embeddings](../../../modalities-and-generative-models/natural-language-processing/sentence-and-document-embeddings/sentence-and-document-embeddings.md)
