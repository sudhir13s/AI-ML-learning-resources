...
- Foundations (the *why* behind vectors & similarity): [AI-ML-intuition 1.02 Dense Embeddings](../../../../AI-ML-intuition/Module_1_Representation/1.02_Dense_Embeddings.md) · [1.06 Vector Similarities — Scaled Dot-Product](../../../../AI-ML-intuition/Module_1_Representation/1.06_Vector_Similarities_The_Scaled_Dot-Product.md) · [06. NLP — Sentence & Document Embeddings](../../../modalities-and-generative-models/natural-language-processing/sentence-and-document-embeddings/sentence-and-document-embeddings.md)
