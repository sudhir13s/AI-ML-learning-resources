...
- **LLM internals — prompting, fine-tuning, decoding, RLHF, KV-cache, long-context** → [LLMs](../README.md) ([Prompting & In-Context Learning](../reasoning-evaluation-and-alignment/prompting-and-in-context-learning/prompting-and-in-context-learning.md) · [Long-Context Methods](../llm-model-architectures/long-context-architectures/long-context-architectures.md) · [Hallucination & Alignment](../reasoning-evaluation-and-alignment/safety-and-alignment/safety-and-alignment.md))
