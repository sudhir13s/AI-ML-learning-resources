...
> [GenAI](../10.%20GenAI/README.md) and are prerequisites here, not duplicated.
...
- **DDPM forward/reverse process** → [GenAI · Diffusion Models — DDPM](../10.%20GenAI/05-Diffusion-Models-DDPM/05-Diffusion-Models-DDPM.md)
- **Score-based & SDE view** → [GenAI · Score-Based & SDE Diffusion](../10.%20GenAI/06-Score-Based-and-SDE-Diffusion/06-Score-Based-and-SDE-Diffusion.md)
- **Latent diffusion / Stable Diffusion** → [GenAI · Latent Diffusion](../10.%20GenAI/07-Latent-Diffusion-Stable-Diffusion/07-Latent-Diffusion-Stable-Diffusion.md)
- **Samplers & guidance (DDIM · CFG)** → [GenAI · Sampling & Guidance](../10.%20GenAI/13-Sampling-and-Guidance-Techniques/13-Sampling-and-Guidance-Techniques.md)
- **Text-to-image systems (DALL·E · Imagen)** → [GenAI · Text-to-Image Systems](../10.%20GenAI/11-Text-to-Image-Systems/11-Text-to-Image-Systems.md)
- **Audio & music diffusion** → [Audio & Speech](../14.%20Audio_and_Speech/README.md)
...
## 🔗 In this platform
- Foundations: [GenAI](../10.%20GenAI/README.md) · Math: [AI-ML-intuition Module 5 (Generation)](../../AI-ML-intuition/Module_5_Generation/)
