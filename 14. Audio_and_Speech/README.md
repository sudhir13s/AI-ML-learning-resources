...
> generation* details live with [Diffusion](../11.%20Diffusion/README.md); this topic owns the
...
- **Sequence decoding (beam search · CTC decoding math)** → [NLP](../06.%20NLP/README.md)
- **Audio diffusion models** → [Diffusion](../11.%20Diffusion/README.md)
- **Audio in multimodal LLMs** → [Multimodal](../12.%20Multimodal/README.md)
- **Fourier analysis & signal processing math** → [Advanced Research Math · Fourier Analysis](../19.%20Advanced_Research_Mathematics/README.md)
...
## 🔗 In this platform
- Language side: [NLP](../06.%20NLP/README.md) · [LLMs](../09.%20LLMs/README.md) · Fusion: [Multimodal](../12.%20Multimodal/README.md)
