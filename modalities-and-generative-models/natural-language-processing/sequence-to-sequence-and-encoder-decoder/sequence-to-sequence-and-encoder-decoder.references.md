...
- Concept depth (the *why* behind attention scores): [AI-ML-intuition 1.06 Scaled Dot-Product (attention scores)](../../../../AI-ML-intuition/representation/similarity-and-distance/scaled-dot-product-intuition.md)
