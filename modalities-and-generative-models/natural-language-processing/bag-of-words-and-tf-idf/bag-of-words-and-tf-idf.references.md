...
**In this platform**:
- Concept page (full explanation): [Bag-of-Words & TF-IDF](bag-of-words-and-tf-idf.md)
- Feeds this (the clean tokens): [Text Preprocessing & Normalization](../text-preprocessing-and-normalization/text-preprocessing-and-normalization.md) · [Tokenization & Subword Algorithms](../tokenization-and-subword-algorithms/tokenization-and-subword-algorithms.md)
- Related representation idea: [N-gram Language Models & Smoothing](../n-gram-language-models-and-smoothing/n-gram-language-models-and-smoothing.md) — the same contiguous-window features, used for prediction.
- The dense successor: [Word Embeddings (Word2Vec, GloVe, FastText)](../word-embeddings-word2vec-glove-fasttext/word-embeddings-word2vec-glove-fasttext.md) · [Contextual Embeddings (ELMo, BERT)](../contextual-embeddings-elmo-bert/contextual-embeddings-elmo-bert.md)
- Puts it to work: [Text Classification & Sentiment Analysis](../text-classification-and-sentiment-analysis/text-classification-and-sentiment-analysis.md) · [Information Retrieval & Semantic Search](../information-retrieval-and-semantic-search/information-retrieval-and-semantic-search.md) · [Topic Modeling (LDA, NMF)](../topic-modeling-lda-nmf/topic-modeling-lda-nmf.md)
