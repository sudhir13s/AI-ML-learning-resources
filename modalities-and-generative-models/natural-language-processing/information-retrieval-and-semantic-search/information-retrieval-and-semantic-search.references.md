...
- Foundations: [k-Nearest-Neighbors](../../../core-machine-learning/supervised-learning/classification/k-nearest-neighbors/k-nearest-neighbors.md) (the search ANN approximates) · [1.06 Vector Similarities — the Scaled Dot-Product](../../../../AI-ML-intuition/representation/similarity-and-distance/scaled-dot-product-intuition.md) (the scoring function)
- Puts it to work: [11 Question Answering](../question-answering/question-answering.md) (the retriever in open-domain QA) · canonical RAG home [11. RAG & LLM Applications](../../../llms-applications-and-agents/rag-and-knowledge-systems/overview.md) · the *why* [AI-ML-intuition 8.02 Retrieval-Augmented Generation](../../../../AI-ML-intuition/memory-retrieval-and-context/retrieval-augmented-generation/rag-intuition.md)
