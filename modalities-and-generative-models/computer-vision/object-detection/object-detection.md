...
> **Note:** this page is the detection *task* and its core machinery. It **builds on** [Image Classification](../image-classification/image-classification.md) — a detector is, at heart, a classifier applied to regions plus a box regressor — and on the [CNN backbone](../../../deep-learning/neural-architectures/cnns-and-convolution/cnns-and-convolution.md) that turns pixels into features. The evaluation metrics (IoU, mAP) get their own dedicated treatment in [10 Detection & Segmentation Metrics](../detection-and-segmentation-metrics/detection-and-segmentation-metrics.md); here we derive and *measure* them because you cannot understand a detector without them.
...
- **The backbone is shared with everything else in vision.** A detector's backbone is the [classification](../image-classification/image-classification.md) backbone; its per-pixel cousin is [semantic segmentation](../semantic-segmentation/semantic-segmentation.md); adding a mask head gives [instance segmentation](../instance-segmentation/instance-segmentation.md) (Mask R-CNN). Detection sits at the center of the vision task family.
