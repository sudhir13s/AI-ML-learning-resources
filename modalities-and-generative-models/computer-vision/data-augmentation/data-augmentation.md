...
## 🔗 In this platform
- Foundation: [Deep Learning › Regularization](../../../deep-learning/optimization-and-training/regularization/regularization.md) · [Deep Learning › Dropout](../../../deep-learning/stabilization-and-architectural-blocks/dropout/dropout.md) — augmentation is a data-side regularizer.
- Related: [Image Classification](../image-classification/image-classification.md) · [Transfer Learning for Vision](../transfer-learning-for-vision/transfer-learning-for-vision.md)
- Next concepts: [11 Vision Transformers](../vision-transformers/vision-transformers.md) · [12 Self-Supervised Vision](../self-supervised-vision/self-supervised-vision.md) (augmentation defines the contrastive views)
