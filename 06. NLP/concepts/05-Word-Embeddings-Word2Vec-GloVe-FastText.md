...
This is the *same instinct* that **subword tokenization** (BPE/WordPiece/Unigram) brings to modern LLMs: never let an unknown word break you — fall back to pieces. See [Tokenization & Subword Algorithms](02-Tokenization-and-Subword-Algorithms.md) for that lineage.
