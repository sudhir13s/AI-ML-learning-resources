...
- Builds on: [Word Embeddings (Word2Vec · GloVe · FastText)](05-Word-Embeddings-Word2Vec-GloVe-FastText.md) — the static vectors we average · [Contextual Embeddings (ELMo · BERT)](06-Contextual-Embeddings-ELMo-BERT.md) — the token-level vectors we pool, and the anisotropy source.
...
- Puts it to work: [Information Retrieval & Semantic Search](16-Information-Retrieval-and-Semantic-Search.md) — BM25, dense retrieval, ANN indexing, and retrieve-then-rerank.
- Related building blocks: [Bag-of-Words & TF-IDF](03-Bag-of-Words-and-TF-IDF.md) — the lexical baseline (and the IDF instinct SIF echoes).
