...
- Builds on these features: [Bag-of-Words & TF-IDF](03-Bag-of-Words-and-TF-IDF.md) · [Word Embeddings (word2vec/GloVe/fastText)](05-Word-Embeddings-Word2Vec-GloVe-FastText.md) · [Contextual Embeddings (ELMo · BERT)](06-Contextual-Embeddings-ELMo-BERT.md)
...
- Evaluation: [Classification Metrics (precision · recall · F1 · ROC-AUC)](../../03.%20Supervised_Learning/concepts/14-Classification-Metrics.md) · [NLP Evaluation Metrics](18-NLP-Evaluation-Metrics.md)
- The token-level cousin: [Sequence Labeling (POS & NER)](09-Sequence-Labeling-POS-and-NER.md)
