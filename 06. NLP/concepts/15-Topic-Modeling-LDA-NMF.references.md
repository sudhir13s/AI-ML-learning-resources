...
- Prior step (the input matrix): [Bag-of-Words & TF-IDF](03-Bag-of-Words-and-TF-IDF.md) — the document–term matrix topic models factorize.
...
- The modern embedding route: [Sentence & Document Embeddings](07-Sentence-and-Document-Embeddings.md) — what BERTopic clusters instead of counts.
- Where LSA connects: [Information Retrieval & Semantic Search](16-Information-Retrieval-and-Semantic-Search.md) — latent semantic indexing links the two.
