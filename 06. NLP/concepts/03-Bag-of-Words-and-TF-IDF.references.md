...
- Feeds this (the clean tokens): [Text Preprocessing & Normalization](01-Text-Preprocessing-and-Normalization.md) · [Tokenization & Subword Algorithms](02-Tokenization-and-Subword-Algorithms.md)
- Related representation idea: [N-gram Language Models & Smoothing](04-N-gram-Language-Models-and-Smoothing.md) — the same contiguous-window features, used for prediction.
- The dense successor: [Word Embeddings (Word2Vec, GloVe, FastText)](05-Word-Embeddings-Word2Vec-GloVe-FastText.md) · [Contextual Embeddings (ELMo, BERT)](06-Contextual-Embeddings-ELMo-BERT.md)
- Puts it to work: [Text Classification & Sentiment Analysis](10-Text-Classification-and-Sentiment-Analysis.md) · [Information Retrieval & Semantic Search](16-Information-Retrieval-and-Semantic-Search.md) · [Topic Modeling (LDA, NMF)](15-Topic-Modeling-LDA-NMF.md)
