...
- Foundations (the metrics these build on): [Classification Metrics — precision/recall/F1](../../03.%20Supervised_Learning/concepts/14-Classification-Metrics.md) · [N-gram Language Models and Smoothing (perplexity)](04-N-gram-Language-Models-and-Smoothing.md)
- Tasks that use these metrics: [Machine Translation (BLEU/chrF/COMET)](12-Machine-Translation.md) · [Text Summarization (ROUGE)](13-Text-Summarization.md) · [Question Answering (EM/F1)](11-Question-Answering.md) · [Sequence Labeling: POS and NER (span F1)](09-Sequence-Labeling-POS-and-NER.md)
- Related: [Decoding Strategies (how the text being scored is produced)](17-Decoding-Strategies.md) · [RLHF and Alignment (human preference data & A/B eval)](../../Practitioner-Workflows/RLHF-and-Alignment/RLHF-and-Alignment.md)
