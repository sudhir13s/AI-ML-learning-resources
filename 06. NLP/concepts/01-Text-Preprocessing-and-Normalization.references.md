...
- Next concept: [Tokenization & Subword Algorithms](02-Tokenization-and-Subword-Algorithms.md) — where preprocessing meets modern subword vocabularies (BPE, WordPiece, SentencePiece, Unigram).
...
- The first models that consume preprocessed text: [Bag-of-Words & TF-IDF](03-Bag-of-Words-and-TF-IDF.md)
- Why transformers want *minimal* preprocessing: [Contextual Embeddings (ELMo / BERT)](06-Contextual-Embeddings-ELMo-BERT.md)
- Tasks where you must *keep* case and stopwords: [Sequence Labeling — POS & NER](09-Sequence-Labeling-POS-and-NER.md)
