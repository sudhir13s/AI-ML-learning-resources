...
- Prior steps (the inputs): [03 Bag-of-Words & TF-IDF](03-Bag-of-Words-and-TF-IDF.md) (lexical / BM25 lineage) · [07 Sentence & Document Embeddings](07-Sentence-and-Document-Embeddings.md) (dense vectors)
...
- Puts it to work: [11 Question Answering](11-Question-Answering.md) (the retriever in open-domain QA) · canonical RAG home [11. RAG & LLM Applications](../../11.%20RAG_and_LLM_Applications/concepts/README.md) · the *why* [AI-ML-intuition 8.02 Retrieval-Augmented Generation](../../../AI-ML-intuition/Module_8_LLMs_and_Agentic_Systems/8.02_Retrieval_Augmented_Generation.md)
