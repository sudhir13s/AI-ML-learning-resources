...
- **Large language models** — BERT · GPT · T5 / BART · Fine-tuning · Prompting · RLHF → [LLMs](../../08.%20LLMs/concepts/README.md)
- **Retrieval-augmented generation** → [RAG & LLM Applications](../../16.%20RAG_and_LLM_Applications/concepts/README.md)
