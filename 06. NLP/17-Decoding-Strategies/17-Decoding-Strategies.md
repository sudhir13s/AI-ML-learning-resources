...
**Decoding choice changes your evaluation numbers.** The decoder is part of the system under test, so it must match the metric ([18 NLP Evaluation Metrics](../18-NLP-Evaluation-Metrics/18-NLP-Evaluation-Metrics.md)):
