...
- Comes before this: [01 Text Preprocessing & Normalization](../01-Text-Preprocessing-and-Normalization/01-Text-Preprocessing-and-Normalization.md)
- Builds on this: [05 Word Embeddings (Word2Vec / GloVe / FastText)](../05-Word-Embeddings-Word2Vec-GloVe-FastText/05-Word-Embeddings-Word2Vec-GloVe-FastText.md) · [06 Contextual Embeddings (ELMo / BERT)](../06-Contextual-Embeddings-ELMo-BERT/06-Contextual-Embeddings-ELMo-BERT.md)
