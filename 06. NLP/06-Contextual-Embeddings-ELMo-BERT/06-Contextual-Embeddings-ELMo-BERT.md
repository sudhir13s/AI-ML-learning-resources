...
1. Tokenize the input (WordPiece [subwords](../02-Tokenization-and-Subword-Algorithms/02-Tokenization-and-Subword-Algorithms.md); see the tokenization page for why subwords).
