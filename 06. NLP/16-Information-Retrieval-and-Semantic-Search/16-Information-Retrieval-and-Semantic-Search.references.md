...
- Puts it to work: [11 Question Answering](../11-Question-Answering/11-Question-Answering.md) (the retriever in open-domain QA) · canonical RAG home [11. RAG & LLM Applications](../../15.%20RAG_and_LLM_Applications/README.md) · the *why* [AI-ML-intuition 8.02 Retrieval-Augmented Generation](../../../AI-ML-intuition/Module_8_LLMs_and_Agentic_Systems/8.02_Retrieval_Augmented_Generation.md)
