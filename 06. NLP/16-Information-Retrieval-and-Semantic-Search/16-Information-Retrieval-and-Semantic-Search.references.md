...
- Foundations: [k-Nearest-Neighbors](../../03.%20Supervised_Learning/04-k-Nearest-Neighbors/04-k-Nearest-Neighbors.md) (the search ANN approximates) · [1.06 Vector Similarities — the Scaled Dot-Product](../../../AI-ML-intuition/Module_1_Representation/1.06_Vector_Similarities_The_Scaled_Dot-Product.md) (the scoring function)
- Puts it to work: [11 Question Answering](../11-Question-Answering/11-Question-Answering.md) (the retriever in open-domain QA) · canonical RAG home [11. RAG & LLM Applications](../../llms-applications-and-agents/rag-and-knowledge-systems/overview.md) · the *why* [AI-ML-intuition 8.02 Retrieval-Augmented Generation](../../../AI-ML-intuition/Module_8_LLMs_and_Agentic_Systems/8.02_Retrieval_Augmented_Generation.md)
