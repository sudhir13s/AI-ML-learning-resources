...
- Math prerequisites (the *why*): [1. Foundations](../../1.%20Foundations/README.md) — sampling, variance of an estimator, generalization.
...
- Related domain: [2. Data Preprocessing](../../2.%20Data_Preprocessing/README.md) — leakage is the #1 way CV lies to you; fit transforms inside each fold.
