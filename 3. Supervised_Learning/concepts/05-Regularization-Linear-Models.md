...
- Math prerequisites (the *why*): [1. Foundations](../../1.%20Foundations/README.md) — norms, convex optimization, MAP estimation.
...
- Related domain: [5. Deep Learning](../../5.%20Deep_Learning/README.md) — L2 regularization reappears as weight decay; dropout is its neural-net cousin.
