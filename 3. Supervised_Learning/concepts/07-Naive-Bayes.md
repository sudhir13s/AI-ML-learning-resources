...
- Math prerequisites (the *why*): [1. Foundations](../../1.%20Foundations/README.md) — probability, Bayes' theorem, conditional independence.
...
- Related domain: [2. Data Preprocessing](../../2.%20Data_Preprocessing/README.md) — text vectorization (bag-of-words, TF-IDF) feeds Naive Bayes.
