...
- Math prerequisites (the *why*): [1. Foundations](../../1.%20Foundations/README.md) — variance, residuals, L1 vs L2 norms.
...
- Related domain: [5. Deep Learning](../../5.%20Deep_Learning/README.md) — MSE/MAE are the standard regression losses for neural nets too.
