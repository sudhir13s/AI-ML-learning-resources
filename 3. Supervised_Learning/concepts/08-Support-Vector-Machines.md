...
- Prior / related concepts: [02 Logistic Regression](02-Logistic-Regression.md) — another linear classifier; SVM maximizes margin, not likelihood · [05 Regularization](05-Regularization-Linear-Models.md) — `C` is an inverse-regularization knob.
