...
- Deeper concept (the *why*): demos, serving & deployment → [Deployment & MLOps](../../14.%20Deployment_and_MLOps/concepts/README.md); LLM apps → [RAG & LLM Applications](../../11.%20RAG_and_LLM_Applications/concepts/README.md)
