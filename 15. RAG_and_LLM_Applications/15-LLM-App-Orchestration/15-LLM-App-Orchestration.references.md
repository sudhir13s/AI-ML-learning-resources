...
- Related domain: [12. Agentic AI](../../16.%20Agentic_AI/README.md) (orchestration becomes agent loops) · [09. LLMs — Prompting & In-Context Learning](../../09.%20LLMs/16-Prompting-and-In-Context-Learning/16-Prompting-and-In-Context-Learning.md)
