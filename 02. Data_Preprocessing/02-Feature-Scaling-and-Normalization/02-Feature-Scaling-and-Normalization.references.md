...
5. **Run it yourself** — open [this chapter's notebook](code/02-Feature-Scaling-and-Normalization.ipynb). *Rebuild the three scalers, match them to scikit-learn, and measure the accuracy jump on real Wine.*
...
**In this platform**:
- Concept page (full explanation): [Feature Scaling & Normalization](02-Feature-Scaling-and-Normalization.md)
- The correctness rule, in full — why fitting preprocessing on all data leaks: [11 Data Leakage](../11-Data-Leakage/11-Data-Leakage.md)
- The split that scaling is fit inside: [10 Train/Validation/Test Splits](../10-Train-Validation-Test-Splits/10-Train-Validation-Test-Splits.md)
- Handle the outliers that make robust scaling necessary: [05 Outlier Detection & Treatment](../05-Outlier-Detection-and-Treatment/05-Outlier-Detection-and-Treatment.md)
- Where scaling lives in a real pipeline (`ColumnTransformer` + `Pipeline`): [13 Data Pipelines](../13-Data-Pipelines/13-Data-Pipelines.md)
- Why the condition number governs gradient-descent convergence: [13 Gradient Descent Theory](../../01.%20Foundations/13-Gradient-Descent-Theory/13-Gradient-Descent-Theory.md) · [04 How Models Learn](../../00.%20Basics/04-How-Models-Learn/04-How-Models-Learn.md)
- The scale-sensitive models this chapter measured: [03 Supervised Learning](../../03.%20Supervised_Learning/README.md) (KNN, SVM) · [04 Unsupervised Learning](../../04.%20Unsupervised_Learning/README.md) (k-means, PCA)
- Normalization taken inside the network (batch/layer norm): [05 Deep Learning](../../05.%20Deep_Learning/README.md)
- Next preprocessing step — building new features: [06 Feature Engineering](../06-Feature-Engineering/06-Feature-Engineering.md)
