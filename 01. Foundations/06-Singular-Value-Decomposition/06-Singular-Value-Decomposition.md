...
- Prereq: [04 Eigenvalues & Eigenvectors](../04-Eigenvalues-and-Eigenvectors/04-Eigenvalues-and-Eigenvectors.md) · Next: [07 PCA — the math](../07-Principal-Component-Analysis-Math/07-Principal-Component-Analysis-Math.md)
