...
> Companion link library for **[Cross-Entropy & KL Divergence](23-Cross-Entropy-and-KL-Divergence.md)**
...
**🔗 In this platform**:
- Concept page (full explanation): [Cross-Entropy & KL Divergence](23-Cross-Entropy-and-KL-Divergence.md)
- Prerequisite (the *why* behind bits and surprise): [22 Entropy](../22-Entropy/22-Entropy.md)
- The unifying theorem it rests on: [19 Maximum Likelihood Estimation](../19-Maximum-Likelihood-Estimation/19-Maximum-Likelihood-Estimation.md) (minimising cross-entropy = MLE)
- Where it goes next: [24 Mutual Information](../24-Mutual-Information/24-Mutual-Information.md) — $I(X;Y) = D_{KL}(\text{joint}\,\|\,\text{product of marginals})$, KL applied to dependence
- Applied downstream: the classification/LM loss deep dives → [AI-ML-intuition 3.03 Categorical Cross-Entropy / NLL](../../../AI-ML-intuition/Module_3_Evaluation/3.03_Categorical_Cross-Entropy_NLL.md) · [5.01 Entropy & KL](../../../AI-ML-intuition/Module_5_Generation/5.01_Information_Theory_Entropy_KL_Divergence.md); the RLHF KL penalty → [LLMs](../../09.%20LLMs/README.md)
- Curriculum context: [Maths for AI-ML — Phase 3 (Information Theory)](../Maths%20for%20AI-ML/README.md)
