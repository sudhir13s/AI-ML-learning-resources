...
> Transformer language models at scale — pretraining, fine-tuning, alignment, and the systems
> that serve them. For *building* one from scratch, see the platform links below.
...
- [Hugging Face LLM Course](https://huggingface.co/learn/llm-course) — **Hugging Face** — fine-tuning, RLHF, deployment, free.
...
## 📰 Articles
- [The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) — **Jay Alammar** — the visual canon.
