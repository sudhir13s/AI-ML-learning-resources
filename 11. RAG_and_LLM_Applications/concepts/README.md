---
id: "11-rag-and-llm-apps/concepts"
...
- **LLM internals — prompting, fine-tuning, decoding, RLHF, KV-cache, long-context** → [LLMs](../../09.%20LLMs/concepts/README.md) ([Prompting & In-Context Learning](../../09.%20LLMs/concepts/16-Prompting-and-In-Context-Learning.md) · [Long-Context Methods](../../09.%20LLMs/concepts/08-Long-Context-Methods.md) · [Hallucination & Alignment](../../09.%20LLMs/concepts/20-Hallucination-and-Alignment-Basics.md))
- **Agents & tool use** (the broader agent loop that Agentic RAG specializes) → [Agentic AI](../../12.%20Agentic_AI/concepts/README.md)
