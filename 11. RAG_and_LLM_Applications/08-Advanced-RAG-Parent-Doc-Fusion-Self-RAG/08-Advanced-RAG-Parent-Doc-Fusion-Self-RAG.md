...
- Prereqs: [07 Query Transformation](../07-Query-Transformation-HyDE-Multi-Query/07-Query-Transformation-HyDE-Multi-Query.md) · [06 Re-ranking](../06-Re-ranking-Cross-Encoders/06-Re-ranking-Cross-Encoders.md) · Next: [09 GraphRAG](../09-GraphRAG/09-GraphRAG.md)
- Related concept: [10 Agentic RAG](../10-Agentic-RAG/10-Agentic-RAG.md) (self-corrective flows become full agent loops) · Related domain: [09. LLMs — Hallucination & Alignment](../../09.%20LLMs/20-Hallucination-and-Alignment-Basics/20-Hallucination-and-Alignment-Basics.md)
