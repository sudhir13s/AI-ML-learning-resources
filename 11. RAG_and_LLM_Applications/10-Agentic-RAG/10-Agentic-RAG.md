...
- Prereqs: [08 Advanced RAG](../08-Advanced-RAG-Parent-Doc-Fusion-Self-RAG/08-Advanced-RAG-Parent-Doc-Fusion-Self-RAG.md) · [07 Query Transformation](../07-Query-Transformation-HyDE-Multi-Query/07-Query-Transformation-HyDE-Multi-Query.md) · Next: [11 RAG Evaluation](../11-RAG-Evaluation/11-RAG-Evaluation.md)
- Related domain: [15. Agentic AI](../../12.%20Agentic_AI/README.md) (the general agent loop this specializes)
