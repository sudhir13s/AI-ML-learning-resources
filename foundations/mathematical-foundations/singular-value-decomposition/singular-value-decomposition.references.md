...
- Applied downstream: dimensionality reduction and latent factors → [Unsupervised Learning](../../../core-machine-learning/unsupervised-learning/README.md); low-rank adaptation of LLM weights → [LoRA & PEFT](../../../09.%20LLMs/12-LoRA-and-PEFT/12-LoRA-and-PEFT.md)
