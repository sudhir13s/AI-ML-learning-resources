...
3. **Get comfortable in Colab** — [Get started with Google Colab](https://www.youtube.com/watch?v=LevQ4efYieU) (Prof. Ryan Ahmed). *Files, GPUs, and the Colab-specific workflow.*
...
- [Get started with Google Colab — Tutorial for Beginners](https://www.youtube.com/watch?v=LevQ4efYieU) — **Prof. Ryan Ahmed** — the Colab workflow, GPUs, and files.
- [A brief intro to Google Colab and Jupyter Notebook](https://www.youtube.com/watch?v=eODjxa2JpzE) — **Cumulus Cycles** — a quick side-by-side intro.
- [PyTorch for Deep Learning — Full Course](https://www.youtube.com/watch?v=V_xro1bcAuA) — **freeCodeCamp** — taught in notebooks; shows the environment in real use.

## 📄 Key Papers
- [Jupyter Notebooks — a publishing format for reproducible computational workflows](https://ebooks.iospress.nl/doi/10.3233/978-1-61499-649-1-87) — **Kluyver et al. (2016)** — the foundational paper (open access via IOS Press).
...
## 🔗 In this platform
- Related domain: [01. Foundations](../../mathematical-foundations/README.md) · [02. Data_Preprocessing](../../data-preparation/)
- Pairs with: [01 NumPy](../numpy/numpy.md) · [02 Pandas](../pandas/pandas.md) · [03 Data Visualization](../data-visualization/data-visualization.md)
