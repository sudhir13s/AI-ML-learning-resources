...
## 🔗 In this platform
- Related domain: [12. Deployment & MLOps](../../18.%20Deployment_and_MLOps/README.md) · [05. Deep Learning](../../05.%20Deep_Learning/README.md)
- Pairs with: [05 PyTorch](../05-PyTorch/05-PyTorch.md) · [06 TensorFlow & Keras](../06-TensorFlow-and-Keras/06-TensorFlow-and-Keras.md)
- Deeper concept (the *why*): model serving & optimization → [Deployment & MLOps](../../18.%20Deployment_and_MLOps/README.md)
