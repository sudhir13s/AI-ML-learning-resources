...
- Deeper concept (the *why*): transformers & LLM internals → [Deep Learning](../../05.%20Deep_Learning/README.md); RAG pipelines → [RAG & LLM Applications](../../llms-applications-and-agents/rag-and-knowledge-systems/overview.md)
