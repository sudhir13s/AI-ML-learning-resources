...
- Deeper concept (the *why*): transformers & LLM internals → [Deep Learning](../../05.%20Deep_Learning/README.md); RAG pipelines → [RAG & LLM Applications](../../15.%20RAG_and_LLM_Applications/README.md)
