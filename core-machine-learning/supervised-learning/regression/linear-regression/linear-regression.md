...
- swap the identity activation for a **sigmoid** → you get [logistic regression](../../classification/logistic-regression/logistic-regression.md) (a classifier);
