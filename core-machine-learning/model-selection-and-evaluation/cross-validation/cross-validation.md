...
- **Stacking / blending** — *out-of-fold* CV predictions are the inputs to a meta-model; using out-of-fold (not in-sample) predictions is what keeps stacking honest (see [Stacking & Blending](../../supervised-learning/trees-and-ensembles/stacking-and-blending/stacking-and-blending.md)).
...
- **Detecting overfitting** — a large train-vs-CV gap flags it; CV *is* how you measure where you sit on the [bias–variance](../bias-variance-tradeoff/bias-variance-tradeoff.md) curve.
