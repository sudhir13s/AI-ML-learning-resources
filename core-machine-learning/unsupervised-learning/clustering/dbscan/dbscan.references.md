...
- Prereqs (the *why* behind the metric): [k-Nearest Neighbors](../../../supervised-learning/classification/k-nearest-neighbors/k-nearest-neighbors.md) (the same neighborhood/KD-tree machinery) · [AI-ML-intuition 1.07–1.08 Euclidean vs Cosine Distance](../../../../../AI-ML-intuition/representation/similarity-and-distance/cosine-vs-euclidean-distance-intuition.md) — density/neighborhoods are defined by the distance metric.
