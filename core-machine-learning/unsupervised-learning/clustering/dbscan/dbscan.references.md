...
- Prereqs (the *why* behind the metric): [k-Nearest Neighbors](../../../supervised-learning/classification/k-nearest-neighbors/k-nearest-neighbors.md) (the same neighborhood/KD-tree machinery) · [AI-ML-intuition 1.07–1.08 Euclidean vs Cosine Distance](../../../../../AI-ML-intuition/Module_1_Representation/1.07-1.08_Similarities_Distances_Euclidean_vs_Cosine.md) — density/neighborhoods are defined by the distance metric.
