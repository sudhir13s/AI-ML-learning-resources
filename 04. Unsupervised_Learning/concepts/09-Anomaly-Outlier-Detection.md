...
- Method ties: [01 K-Means](01-K-Means-Clustering.md) (distance-to-centroid scoring) · One-Class SVM uses [the kernel trick → Foundations](../../01.%20Foundations/Maths%20for%20AI-ML/README.md)
