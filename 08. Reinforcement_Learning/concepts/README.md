...
- **RLHF / alignment for LLMs** — reward models, PPO-on-language, DPO → [09. LLMs](../../09.%20LLMs/README.md). *RL owns the policy-gradient / PPO **mechanics** ([12](12-Proximal-Policy-Optimization-PPO.md)); the LLM-alignment RLHF card lives in the LLMs section and links back here.*
