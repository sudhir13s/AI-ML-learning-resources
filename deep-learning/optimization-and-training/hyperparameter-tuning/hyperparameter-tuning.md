...
4. **Regularization** — weight decay (log scale), dropout rate (linear), label smoothing, augmentation strength. These trade bias for variance; tune once the model is training stably. (See [Regularization](../regularization/regularization.md).)
